            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="dropdown nav-item">
                ...
                <ul class="dropdown-menu dropdown-navbar">
                  ...
                  <li class="nav-link">
                    <a href="../signout.php" class="nav-item dropdown-item">Log out</a>
                  </li>
                </ul>
              </li>
                ...
                <div class="table-responsive">
                  <table class="table tablesorter " id="myTable">
                    <thead class=" text-primary">
                      ...
                      <div class="form-group">
                            <div class="input-group">
                              ...
                              <input id="myInput" onkeyup="myFunction()" type="text" class="form-control" placeholder="Search name">
                            </div>
                      </div>
                    </div>
                    ...
                    <tbody>
                              ...
                              //$sid = $_REQUEST['sid'];
                              //$pname = $_SESSION['user'];
                              //$sql = $DBH->prepare("SELECT * FROM tbl_account LEFT JOIN tbl_student_subject ON tbl_student_subject.cAccIdNumber = tbl_account.cAccIdNumber AND tbl_student_subject.cSubjectCode = :sid WHERE tbl_student_subject.cAccIdNumber = :sid IS NULL AND tbl_account.cType ='user'");
                              ...
                              <tr>
                                ...
                                <td><?php //echo $row['cCourse']." ".$row['cYearLevel'];?></td>
                                <td><?php //echo $row['cDepartment'];?></td>
                                <td>
                                <button type="button" class="btn btn-success btn-sm" onclick="window.location.href='../api/addstudonsubj.php?id=<?php //echo $row['cAccIdNumber'];?>&amp;sid=<?php //echo $sid;?>'"><i class="tim-icons icon-simple-add"></i>&nbsp;Add Student</button>
                                </td>
                              </tr>
                              <?php
                              ...
                              <?php
                              $sid = $_REQUEST['sid'];
                              $sql = $DBH->prepare("SELECT tbl_account.cAccIdNumber,cFirstName,cLastName,cCourse,cYearLevel,cDepartment FROM tbl_account LEFT JOIN tbl_student_subject ON tbl_student_subject.cAccIdNumber = tbl_account.cAccIdNumber AND tbl_student_subject.cSubjectCode = :sid WHERE tbl_student_subject.cAccIdNumber = :sid IS NULL AND tbl_account.cType ='user'");
                              $sql->setFetchMode(PDO::FETCH_ASSOC);
                              $sql->bindparam(":sid",$sid);
                              $sql->execute();
                              while($row=$sql->fetch()) {
