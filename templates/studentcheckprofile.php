                ...
                <div class="table-responsive">
                  <table class="table tablesorter " id="myTable">
                    ...
                    <tbody>
                      ...
                      <?php
                              $sql = $DBH->prepare("SELECT * FROM tbl_account WHERE cType = 'user'");
                              ...
                              <tr>
                                ...
                                <td>
                                  <button type="button" class="btn btn-success btn-sm" onclick="window.location.href='checkprofile.php?id=<?php echo $row['cAccIdNumber'];?>'"><i class="tim-icons icon-single-02"></i>&nbsp; View</button>
                                </td>
                              </tr>
                              <?php
                              }
