            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <?php  
                        ...
                        $id = $_REQUEST['id'];
                        $sql = $DBH->prepare("SELECT * FROM tbl_account WHERE cAccIdNumber = :id");
                        $sql->bindparam(":id",$id);
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-md-1">
                      <div class="form-group">
                        <label>Email</label>
                        <input name="txtemailadd" type="email" class="form-control" placeholder="Email" disabled="" value="<?php echo $txtemail ?>">
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 pl-md-1">
                      <div class="form-group">
                        <label>Course</label>
                        <select name="txtcourses" id="inputState" class="form-control" disabled="" >
                          <?php
                          if($txtcourse == "BSIT"){
                    ...
                    <div class="col-md-3 pl-md-1">
                      <div class="form-group">
                        ...
                        <select name="txtyearlevel" id="inputState" class="form-control" disabled="">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Address</label>
                        <input name="txtaddress" type="text" class="form-control" placeholder="Home Address" value="<?php echo $txtadd?>" disabled="">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-8">
                      <div class="form-group">
                        ...
                        <textarea name="txtaboutme" rows="4" cols="80" class="form-control" placeholder="Here can be your description" value="<?php echo $txtabout ?>"  disabled=""><?php echo $txtabout ?></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="card-footer">
                    <a href="studentcheckprofile.php" type="button" class="btn btn-fill btn-primary">Back</a>
                  </div>
              </div>
