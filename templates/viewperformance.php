      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">Performance</a>
          </div>
          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header">
                <h4 class="card-title">Enrolled Subject List</h4>
              </div>
              <div class="card-body">
                  ...
                  <table class="table tablesorter " id="">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                        <button type="button" class="btn btn-success btn-sm" onclick="window.location.href='selectedperformanceview.php?sid=<?php echo $row['cSubjectCode'];?>'"><i class="tim-icons icon-chart-bar-32"></i>&nbsp; View</button>
                        </td>
                      </tr>
                      <?php } ?>
