        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header">
                <div class="row">
                  <div class="col-9">
                    <h4 class="card-title">Student Performance <button type="button" class="btn btn-secondary" onclick="window.location.href='sample.php'">Add Grade</button></h4>
                  </div>
                ...
                <div class="table-responsive">
                   <div class="col-3">
                    <div class="form-group">
                      ...
                      <select onclick="myFunction()" class="form-control" id="myInput">
                       <?php
                  ...
                  <table class="table tablesorter " id="myTable">
                    ...
                    <tbody>
                      <?php
                        $sql = $DBH->prepare("SELECT * FROM tbl_student_subject");
                        $sql->setFetchMode(PDO::FETCH_ASSOC);
                        $sql->BINDPARAM(":b",$aaa);
                        $sql->execute();
                        while($row=$sql->fetch()) {
                      ...
                      <tr>
                        ...
                        <td>
                         <td>
                           <button type="button" class="btn btn-secondary" onclick="window.location.href='updatestudentperf.php?term123=<?php echo $row['cAccIdNumber'];?>&term=Prelim'">Prelim</button>
                            <button type="button" class="btn btn-secondary" onclick="window.location.href='updatestudentperf.php?term123=<?php echo $row['cAccIdNumber'];?>&term=Midterm'">Midterm</button>
                            <button type="button" class="btn btn-secondary" onclick="window.location.href='updatestudentperf.php?term123=<?php echo $row['cAccIdNumber'];?>&term=Finals'">Finals</button>
                        </td>
                        </td>
                      </tr>
                      <?php
            ...
            <div class="card ">
              <div class="card-header">
                  <div class="row">
                  <div class="col-6">
                  <h4 class="card-title">Student evaluation</h4>
                </div>
          ...
          <!-- <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel" style="color:orange;">UPDATE</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          ...
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" onclick="window.location.href='updatestudentperf.php'">Prelim</button>
                            <button type="button" class="btn btn-secondary" onclick="window.location.href='updatestudentperf.php'">Midterm</button>
                            <button type="button" class="btn btn-secondary" onclick="window.location.href='updatestudentperf.php'">Finals</button>
                          </div>
                        </div>
                      </div>
                    </div> -->
