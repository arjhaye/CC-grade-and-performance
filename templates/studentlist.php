                ...
                <div class="table-responsive">
                  ...
                  <div class="col-3 float-right">
                    <div class="form-group">
                      ...
                      <select class="form-control" id="myInput" onclick="myFunction()">
                         <?php
                                  ...
                                  while($row=$sql->fetch()) {
                                  ?>
                                  <option style="color: orange;"><?php echo $row['cSubjectCode'];?></option>
                                  <?php
                                  }
                                  ?>
                      </select>
                      ...
                      <tr>
                        <th>Id Number</th>
                        <th>SubjectCode & SubjectDescription</th>
                        <th>Time & Day</th>
                        <th>Room</th>
                        <th>School Year</th>
                        <th>Action</th>
                    ...
                    <tbody>
                        ...
                        // $b = $_SESSION['user'];
                        // $sql = $DBH->prepare("SELECT * FROM tbl_account WHERE cLastName = :b ");
                        // $sql->setFetchMode(PDO::FETCH_ASSOC);
                        // $sql->BINDPARAM(":b",$b);
                        // $sql->execute();
                        // while($row=$sql->fetch()) {
                        ...
                        $sql = $DBH->prepare("SELECT * FROM tbl_student_subject WHERE cProf = :txtuser AND cStatus ='Active'");
                        $sql->setFetchMode(PDO::FETCH_ASSOC);
                        $sql->BINDPARAM(":txtuser",$txtuser);
                        $sql->execute();
                        while($row=$sql->fetch()) {
                        ...
                        <tr>
                          ...
                          <td>
                            <!-- <button type="button" class="btn btn-success btn-sm"><i class="tim-icons icon-simple-add"></i>&nbsp;Add Student</button> -->
                            <button type="button" class="btn btn-danger btn-sm" onclick="window.location.href='../api/dropstudent.php?id=<?php echo $row['cId'];?>'"><i class="tim-icons icon-simple-add"></i>&nbsp;Drop Student</button>
                          </td>
                        </tr>
                        <?php
                        }
