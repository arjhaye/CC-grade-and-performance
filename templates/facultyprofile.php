      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">Faculty Profile</a>
          </div>
                  ...
                  <div class="row">
                    <div class="col-md-5 pr-md-1">
                      <div class="form-group">
                        <label>Faculty ID (disabled)</label>
                        <input type="text" class="form-control" disabled="" value="15310001">
                      </div>
                    </div>
                    <div class="col-md-3 px-md-1">
                      <div class="form-group">
                        <label>First Name</label>
                        <input type="text" class="form-control" placeholder="" value="Francis">
                      </div>
                    </div>
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Last Name</label>
                        <input type="email" class="form-control" placeholder="" value="Deramos">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6 pr-md-1">
                      <div class="form-group">
                        <label>Email</label>
                        <input type="email" class="form-control" placeholder="Email" value="francis.deramos@gmail.com">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Address</label>
                        <input type="text" class="form-control" placeholder="Home Address" value="Olongapo City">
                      </div>
                    </div>
                  </div>
                  <!-- <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-8">
                      <div class="form-group">
                        ...
                        <textarea rows="4" cols="80" class="form-control" placeholder="Here can be your description" value="Mike">SF SF?.</textarea>
                      </div>
                    </div>
                  </div>
                </form>
                ...
                <p class="card-text">
                  <div class="author">
                    ...
                    <a href="javascript:void(0)">
                      ...
                      <h5 class="title">15310001</h5>
                      <h5 class="title">Francis Deramos</h5>
                      <h5 class="title">Faculty Staff</h5>
                      <h5 class="title">francis.deramos@gmail.com</h5>
                      <h5 class="title">Olongapo City</h5>
                    </a>
                  </div>
                </p>
